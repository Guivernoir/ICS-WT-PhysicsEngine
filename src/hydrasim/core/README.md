...
```bash
# Clone or copy the hydrasim directory
cd /path/to/your/project

# Import in your code
from hydrasim.core import IntegratedCSTR, ReactorConfiguration, BoundaryConditions
```
...
```python
from hydrasim.core import run_all_validations

# Run all tests
run_all_validations()

# Or run individual modules
from hydrasim.core import validate_thermodynamics, validate_chemistry
