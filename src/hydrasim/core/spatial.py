...
class SpatialModel:
    ...
    def print_spatial_diagnostics(self) -> None:
        from .spatial_diagnostics import print_spatial_diagnostics

        print_spatial_diagnostics(self)


def validate_spatial() -> None:
    from .spatial_validation import validate_spatial as run_validation

    run_validation()


if __name__ == "__main__":
    from .spatial_validation import demo_spatial
